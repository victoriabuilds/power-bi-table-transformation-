...
Project Overview
This project demonstrates Power BI data transformation skills using Power Query. The task involved connecting to multiple CSV files, cleaning data, creating calculated columns, and preparing the model for reporting.
